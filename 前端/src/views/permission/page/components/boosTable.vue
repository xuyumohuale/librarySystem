<template>
  <el-card class="box-card">
    <template #header>
      <div class="card-header">
        <div style="display: grid; grid-template-columns: 12fr 4fr">
          <span
            >图书列表
            <el-button style="margin: 5px" type="primary" plain @click="addBook"
              >添加图书</el-button
            ></span
          >
        ...
        >
          ...
          <el-table-column align="right">
            <template #default="scope">
              <el-button type="danger" @click="open1(scope.row)"
                >删除图书</el-button
              >
              <el-button round @click="reserve(scope.row)">编辑图书</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
  ...
  <dialogView
    ...
    :data="selected_book"
    @success_update="findAndSetBooks"
